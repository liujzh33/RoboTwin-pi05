#!/usr/bin/env python3
"""
批量对 blocks_ranking_size 任务的 episode 做轨迹分析并保存为 PNG。
使用 blocks_ranking_size_v1 的 13 阶段纯夹爪划分与 analyze_trajectory_blocks_ranking_size.py。
"""
...
ANALYZE_SCRIPT_NAME = "analyze_trajectory_blocks_ranking_size.py"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Batch analyze blocks_ranking_size trajectories (v1)")
    parser.add_argument("--data_dir", required=True, help="Processed data dir containing episode_*")
