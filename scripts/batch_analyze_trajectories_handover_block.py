...
ANALYZE_SCRIPT_NAME = "analyze_trajectory_handover_block.py"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", required=True, help="processed_data/.../handover_block-...-N")
