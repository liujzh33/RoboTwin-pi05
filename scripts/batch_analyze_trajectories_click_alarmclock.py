#!/usr/bin/env python3
"""
批量对 click_alarmclock 任务的 episode 做轨迹分析并保存为 PNG（3 阶段纯夹爪划分）。
"""
...
ANALYZE_SCRIPT_NAME = "analyze_trajectory_click_alarmclock.py"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Batch analyze click_alarmclock trajectories (3 phases)")
