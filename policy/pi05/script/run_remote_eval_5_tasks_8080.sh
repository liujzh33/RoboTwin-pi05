#!/bin/bash
# =============================================================================
# 远程评估（端口 8080）：5 个任务，每个跑 clean + random，共 10 次；每次 5 个 eval
# 任务: press_stapler, place_mouse_pad, open_laptop, lift_pot, place_bread_skillet
# 用法: ./script/run_remote_eval_5_tasks_8080.sh
# 可选: CLIENT_GPU=1
# =============================================================================
...
echo "=========================================="
echo "Remote Eval (port ${REMOTE_PORT}): 5 tasks × 2 envs = 10 runs, ${TEST_NUM} evals each"
