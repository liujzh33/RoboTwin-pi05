#!/bin/bash
# lfwj_rl 权重 + open_gripper 扰动（eval_policy_initial_motus_open_gripper.py）
# 权重: .../checkpoints/pi05_rl_aloha_reward/lfwj_rl/15000，每任务 10 次 eval
...
CKPT_SETTING="${CKPT_SETTING:-lfwj_rl_open_gripper}"
...
echo "=========================================="
echo "lfwj_rl 权重 + open_gripper 扰动"
