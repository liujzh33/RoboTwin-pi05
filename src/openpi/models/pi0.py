    ...
    def embed_prefix(
        ...
        if n_obs_steps > 1:
            ...
            for name in obs.images:
                image = obs.images[name]  # Shape: [batch, n_obs_steps, h, w, c]
                image_mask = obs.image_masks[name]  # Shape: [batch, n_obs_steps]
        ...
        if obs.tokenized_prompt is not None:
            ...
            if tokenized_prompt_mask is not None and tokenized_prompt_mask.ndim == 3:
