...
class PI0:
    ...
    def get_action(self):
        ...
        self._last_infer = self.policy.infer(self.observation_window)
        return self._last_infer["actions"]

    def reset_obsrvationwindows(self):
        self.instruction = None
        self.observation_window = None
        # Reset observation history queues if multi-frame stacking is enabled
